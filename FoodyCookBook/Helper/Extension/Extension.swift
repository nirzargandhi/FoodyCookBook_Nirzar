...
extension UIViewController {
    ...
    func setNavigationHeader(strTitleName : String = "", isTabbar : Bool = true) {
        ...
        label.font = UIFont(name: "Proxima Nova Bold", size: 20.0)!
        ...
        if isTabbar {
            ...
            self.tabBarController?.navigationController?.navigationBar.barTintColor = .appBlackColor()
            ...
            self.navigationController?.navigationBar.barTintColor = .appBlackColor()
            self.navigationController?.navigationBar.tintColor = .white
            self.navigationController?.navigationBar.isTranslucent = false
        }
    }
    
    //MARK: - Open Side Menu VC Method
    func openSideMenuVC() {
    ...
    func setBackButton(isTabbar : Bool = false) {
        let btnBack = UIBarButtonItem(image: #imageLiteral(resourceName: "ic_back_arrow"), style: .plain, target: self, action: #selector(popVC))

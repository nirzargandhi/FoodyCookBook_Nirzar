...
class ShadowView : UIView {
    ...
    override func layoutSubviews() {
        ...
        if shadowLayer == nil {
            ...
            shadowLayer.fillColor = UIColor.clear.cgColor//UIColor.white.cgColor//UIColor.LoginShadowGreen().cgColor
...
//MARK: - Top & Bottom - Left & Right Corners
extension UIView {
